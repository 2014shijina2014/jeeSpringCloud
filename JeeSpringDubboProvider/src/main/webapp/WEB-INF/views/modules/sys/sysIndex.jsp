                    ...
                    <div class="navbar-header">
                        ...
                        <form role="search" class="navbar-form-custom" method="post" action="search_results.html">
                            <div class="form-group">
                                <input type="text" placeholder="${fns:getConfig('productName')}-${systemMode}-${version}" readonly="true" enabled="false" class="form-control" name="top-search" id="top-search" style="font-weight:700;font-size:20px;width: 400px;">
                            </div>
                        </form>
                    </div>
