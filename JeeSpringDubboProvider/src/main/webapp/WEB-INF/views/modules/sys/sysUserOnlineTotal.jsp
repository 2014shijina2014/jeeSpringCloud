...
<%@ include file="/WEB-INF/views/include/head.jsp"%>
	<script src="/static/views/modules/sys//sysUserOnlineTotal.js" type="text/javascript"></script>
	<link href="/static/views/modules/sys//sysUserOnlineTotal.css" rel="stylesheet" />
