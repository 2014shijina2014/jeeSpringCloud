...
<body class="gray-bg">
	<form:form id="inputForm" modelAttribute="sysDictTree" action="${ctx}/sys/sysDictTree/save" method="post" class="form-horizontal  content-background">
		<div class="content">
			<form:hidden path="id"/>
			...
			<table class="width-100  table-condensed dataTables-example dataTable no-footer">
			   <tbody>
				...
				<tr>
					...
					<td class="width-35">
						<sys:treeselect id="parent" name="parent.id" value="${sysDict.parent.id}" labelName="parent.name" labelValue="${sysDict.parent.name}"
							title="父级编号" url="/sys/sysDictTree/treeData" extId="${sysDict.id}" cssClass="form-control " allowClear="true"/>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="width-35">
						...
						<sys:ckfinder input="picture" type="files" uploadPath="/sys/sysDict" selectMultiple="true"/>
