...
<head>
    ...
    <script src="/static/views/modules/test/one/formLeaveTotal.js" type="text/javascript"></script>
	<link href="/static/views/modules/test/one/formLeaveTotal.css" rel="stylesheet" />
</head>
...
<c:forEach items="${list}" var="formLeave">
	...
	{title:"请假单<br>统计${sumTotalCount}次。"
	,content:""
