			...
			<tr>
				...
				<td>
					<!--shiro:hasPermission name="test:one:formLeave:view"-->
						<a href="#" onclick="openDialogView('查看请假单', '${ctx}/test/one/formLeave/form?id=${formLeave.id}','800px', '500px')" class="btn btn-info btn-sm" ><i class="fa fa-search-plus"></i> 查看</a>
					<!--/shiro:hasPermission-->
				</td>
			</tr>
		</c:forEach>
