	...
	<form:form id="inputForm" modelAttribute="testDataMain" action="${ctx}/test/onetomany/testDataMain/save" method="post" class="form-horizontal content-background">
		...
		<sys:message content="${message}"/>
				<div class="form-group">
					<label class="col-sm-2 pull-left">编号<font color="red">*</font></label>
					<div class="col-sm-9 col-lg-10 col-xs-12">
						<form:input path="id" htmlEscape="false" maxlength="64" class="form-control required"/>
					<div class="help-block">请填写编号</div>
									</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 pull-left">创建者<font color="red">*</font></label>
					<div class="col-sm-9 col-lg-10 col-xs-12">
						<form:input path="createBy.id" htmlEscape="false" maxlength="64" class="form-control required"/>
					<div class="help-block">请填写创建者</div>
									</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 pull-left">创建时间<font color="red">*</font></label>
					<div class="col-sm-9 col-lg-10 col-xs-12">
						<input id="createDate" name="createDate" type="text" maxlength="20" class="laydate-icon form-control layer-date required"
							value="<fmt:formatDate value="${testDataMain.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
						<div class="help-block">请选择创建时间</div>
									</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 pull-left">更新者<font color="red">*</font></label>
					<div class="col-sm-9 col-lg-10 col-xs-12">
						<form:input path="updateBy.id" htmlEscape="false" maxlength="64" class="form-control required"/>
					<div class="help-block">请填写更新者</div>
									</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 pull-left">更新时间<font color="red">*</font></label>
					<div class="col-sm-9 col-lg-10 col-xs-12">
						...
						<div class="help-block">请选择更新时间</div>
									</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 pull-left">删除标记<font color="red">*</font></label>
					<div class="col-sm-9 col-lg-10 col-xs-12">
						<form:radiobuttons path="delFlag" items="${fns:getDictList('del_flag')}" itemLabel="label" itemValue="value" htmlEscape="false" class="i-checks required"/>
						<div class="help-block">请选择删除标记</div>
									</div>
				</div>
