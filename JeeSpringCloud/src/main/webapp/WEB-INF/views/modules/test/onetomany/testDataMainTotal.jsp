...
<%@ include file="/WEB-INF/views/include/head.jsp"%>
	<script src="/static/views/modules/test/onetomany/testDataMainTotal.js" type="text/javascript"></script>
	<link href="/static/views/modules/test/onetomany/testDataMainTotal.css" rel="stylesheet" />
