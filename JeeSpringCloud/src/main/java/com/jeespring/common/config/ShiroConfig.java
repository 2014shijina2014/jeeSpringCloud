...
public class ShiroConfig {
    ...
    public String shiroFilterChainDefinitions(Environment environment, @Value("${adminPath}") String adminPath) {
        ...
        string += adminPath + "/loginBase = anon\n";
        string += adminPath + "/logout = logout\n";
        string += adminPath + "/register = anon\n";
        string += adminPath + "/sys/register/registerUser = anon\n";
        string += adminPath + "/sys/user/validateLoginName = anon\n";
        string += adminPath + "/sys/user/validateMobile = anon\n";
